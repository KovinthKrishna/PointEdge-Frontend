...
const DiscountOptionsDashboard: React.FC<DiscountOptionsDashboardProps> = ({
  onReportClick,
  onAddClick,
  discountCount: initialDiscountCount
}) => {
  ...
  const [discountCount, setDiscountCount] = useState(initialDiscountCount);
  ...
  useEffect(() => {
    const fetchCount = async () => {
      try {
        const response = await fetchDiscountCount();
        console.log('Fetched discount count:', response.count);
        setDiscountCount(response.count);
      } catch (error) {
  ...
  const handleFinalDelete = async () => {
    ...
    try {
        setIsDeleting(true);
        console.log("Attempting to delete with password:", adminPassword);
        
        // Use the imported service function
        const result = await deleteAllDiscounts(adminPassword.trim());
        
        console.log("Deletion successful:", result);
        showNotification('All discounts deleted successfully', 'success');
  ...
  // Modal styles (updated to match DiscountTableDashboard)
    ...
    <div style={{ position: 'relative', zIndex: 1 }}>
      <div style={{
        ...
        <div style={{
          ...
          >
            <FaFlag style={{ marginRight: '8px', fontSize: '14px' }} />
            Report
          </button>
          ...
          <div style={overlayStyle}>
            <div style={modalStyle}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <h3 style={{ margin: 0, fontSize: '18px', fontWeight: '600', color: '#111827' }}>Confirm Delete All</h3>
                <button 
              ...
              <p style={{ 
                ...
                Are you sure you want to delete ALL discounts? This action cannot be undone.
              </p>
          ...
          <div style={overlayStyle}>
            <div style={modalStyle}>
              ...
              <p style={{ 
                ...
                To delete ALL discounts, please enter your admin password:
              </p>
...
export default DiscountOptionsDashboard;