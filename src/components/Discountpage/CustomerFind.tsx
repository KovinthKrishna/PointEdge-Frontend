...
const CustomerOrders: React.FC<CustomersPopupProps> = ({
  ...
  const getTierIcon = (tier?: "GOLD" | "SILVER" | "BRONZE" | "NOTLOYALTY") => {
    switch (tier) {
      case "GOLD":
        return <FaCrown color="#FFD700" size={16} />;
      case "SILVER":
        return <FaMedal color="#C0C0C0" size={16} />;
      case "BRONZE":
        return <FaAward color="#CD7F32" size={16} />;
      default:
        return null;
    }
  };
      ...
      case 0:
        return (
          <FaTrophy
            color="#FFD700"
            size={16}
            className="trophy-icon gold bounce"
          />
        );
      case 1:
        return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <FaArrowLeft
              color={openedFrom === "payment" ? "#999" : "#003049"}
              size={20}
            />
          </button>
            ...
            >
              ...
              >
                <FaCrown
                  color="#FFD700"
                  size={16}
                  className="trophy-icon silver shake"
                />
              ...
              >
                <FaUsers
                  color="#999"
                  size={16}
                  className="trophy-icon bronze pulse"
                />
        ...
        >
          ...
          >
            <div style={{ marginBottom: "15px" }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setCustomerData({
                    ...customerData,
                    title: e.target.value as "MR" | "MRS" | "OTHER",
                  })
                }
            ...
            {error && (
              <div
                style={{ color: "#FF3B30", fontSize: "12px", marginTop: "5px" }}
              >
                {error}
              </div>
            )}
