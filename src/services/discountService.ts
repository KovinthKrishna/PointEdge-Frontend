...
const deleteAllDiscountsClient = new APIClient(
  "/discount/delete-all-discounts"
);
const deleteItemDiscountsClient = new APIClient(
  "/discount/delete-discounts-by-type/ITEM"
);
const deleteCategoryDiscountsClient = new APIClient(
  "/discount/delete-discounts-by-type/CATEGORY"
);
const deleteLoyaltyDiscountsClient = new APIClient(
  "/discount/delete-discounts-by-type/LOYALTY"
);
const discountItemCountClient = new APIClient("/discount/count-by-type/ITEM");
const discountCategoryCountClient = new APIClient(
  "/discount/count-by-type/CATEGORY"
);
const discountLoyaltyCountClient = new APIClient(
  "/discount/count-by-type/LOYALTY"
);
const loyaltyThresholdsClient = new APIClient("/discount/loyalty-thresholds");
const allDiscountsClient = new APIClient<Discount[]>(
  "/discount/get-all-discounts"
);
const singleDiscountClient = new APIClient<Discount>(
  "/discount/get-discount-by-id"
);
const discountItemsClient = new APIClient<Discount[]>(
  "/discount/get-discounts-by-type/ITEM"
);
const discountCategoriesClient = new APIClient<Discount[]>(
  "/discount/get-discounts-by-type/CATEGORY"
);
const discountLoyaltiesClient = new APIClient<Discount[]>(
  "/discount/get-discounts-by-type/LOYALTY"
);

// Fetch product names function
export const fetchProductNames = async (): Promise<
...
export const fetchCategoryNames = async (): Promise<
  Array<{ id: number; name: string }>
> => {
  try {
...
export const deleteAllItemDiscounts = async (
  adminPassword: string
): Promise<{ success: boolean; message?: string }> => {
  try {
    ...
    if (axios.isAxiosError(error)) {
      const errorMessage =
        error.response?.data?.message || "Failed to delete item discounts";
      throw new Error(errorMessage);
    }
    throw error;
  }
...
export const deleteAllCategoryDiscounts = async (
  adminPassword: string
): Promise<{ success: boolean; message?: string }> => {
  try {
    ...
    if (axios.isAxiosError(error)) {
      const errorMessage =
        error.response?.data?.message || "Failed to delete category discounts";
      throw new Error(errorMessage);
    }
    throw error;
  }
...
export const deleteAllLoyaltyDiscounts = async (
  adminPassword: string
): Promise<{ success: boolean; message?: string }> => {
  try {
    ...
    if (axios.isAxiosError(error)) {
      const errorMessage =
        error.response?.data?.message || "Failed to delete Loyalty discounts";
      throw new Error(errorMessage);
    }
    throw error;
  }
...
export const updateLoyaltyThresholds = async (
  ...
  try {
    ...
    if (axios.isAxiosError(error)) {
      const errorMessage =
        error.response?.data?.message || "Failed to update loyalty thresholds";
      return {
        success: false,
