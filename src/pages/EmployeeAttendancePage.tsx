          ...
          <Tbody>
            {employees.map((employee) => (
              <Tr key={employee.id}>
                ...
                <Td>
                <Badge
                      bg={employee.status === "Active" ? "rgba(72, 187, 120, 0.2)" : "rgba(245, 101, 101, 0.2)"}
                      color={employee.status === "Active" ? "green.600" : "red.600"}
                      px={3}
                      py={1}
                      rounded="full"
                      width="70px"
                      textAlign="center"
                      border="1px solid"
                      borderColor={employee.status === "Active" ? "green.200" : "red.200"}
                    >
                    {employee.status}
                  </Badge>
                </Td>
