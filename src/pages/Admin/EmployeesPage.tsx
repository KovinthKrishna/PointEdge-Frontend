...
const EmployeesPage = () => {
  ...
  const tabFontSize = useBreakpointValue({ base: "12px", sm: "14px", md: "16px" });
  ...
  const buttonMinW = useBreakpointValue({ base: "70px", sm: "85px", md: "100px" });
  const buttonText = useBreakpointValue({ base: "Reg", sm: "Register", md: "Register" });
  const contentPadding = useBreakpointValue({ base: 2, sm: 3, md: 4 });
  const maxTabWidth = useBreakpointValue({ base: "80px", sm: "110px", md: "140px" });
  const minTabWidth = useBreakpointValue({ base: "65px", sm: "85px", md: "100px" });
  const borderWidth = useBreakpointValue({ base: "8px", sm: "10px", md: "12px" });
  const headerHeight = useBreakpointValue({ base: "4.25rem", sm: "5rem", md: "5.5rem" });
      ...
      >
        ...
        >
          ...
          <Button
            ...
            fontSize={useBreakpointValue({ base: "12px", sm: "14px", md: "16px" })}
